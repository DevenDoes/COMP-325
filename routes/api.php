...
Route::get('/papers/{paper}/sources', 'SourceController@index');
...
Route::get('/papers/{paper}/evidence', 'EvidenceController@index');
...
Route::get('/papers/{paper}/analyses', 'AnalysisController@index');
...
Route::post('/paper/{paper}/analyses/{analysis}/evidence', 'AnalysisEvidenceController@store');
Route::delete('/paper/{paper}/analyses/{analysis}/evidence', 'AnalysisEvidenceController@destroy');

Route::get('/papers/{paper}/arguments', 'ArgumentController@index');
...
Route::get('/papers/{paper}/outlines', 'OutlineController@index');
